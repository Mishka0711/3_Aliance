...
$our_production_text = 'Прежде всего, начало повседневной работы по формированию позиции однозначно фиксирует необходимость приоритизации разума над эмоциями. Кстати, представители современных социальных резервов неоднозначны и будут описаны максимально подробно.<br>';
    ...
    <div class="separator"></div>
        ...
        <ul class="autohim-kinds-list">
          ...
          foreach ($autohim_kinds_list as $svg_id) {
            echo '<li class=" autohim-kinds-item">'.$svg_id.'</li> ';
            };
          ?>
        </ul>
